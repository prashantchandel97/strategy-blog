...
- **Infrastructure moat | measurement moat | distribution advantage**: 2026-06-08 — 12-18 month | 3-7 year | indefinite lifespan
- **Per-seat pricing**: 2026-06-08 — charging per user, broken by AI automation
- **Outcome-based pricing**: 2026-06-08 — charging per verified result
- **Validation scope**: 2026-06-15 — gap between conditions where moat proven vs. deployed
- **Data-native work**: 2026-06-22 — work producing structured, deterministic outcomes (transactions, invoices)
